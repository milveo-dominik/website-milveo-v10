        ...
        <div className="flex lg:flex-row flex-col lg:items-center gap-10">
          ...
          <div className="flex flex-col flex-1 gap-4 pl-0 lg:pl-20">
            ...
            <div className="gap-6 grid grid-cols-1 md:grid-cols-2 mt-8">
              <div className="flex flex-col gap-2">
                <h3 className="flex items-center font-semibold text-xl"><TimerIcon className="mr-2 w-4 h-4" />Sichtbarkeit steigern</h3>
              ...
              <div className="flex flex-col gap-2">
              <h3 className="flex items-center font-semibold text-xl"><TimerIcon className="mr-2 w-4 h-4" />Vertrauen aufbauen</h3>
              ...
              <div className="flex flex-col gap-2">
              <h3 className="flex items-center font-semibold text-xl"><TimerIcon className="mr-2 w-4 h-4" />Mehr Kunden / Leads</h3>
              ...
              <div className="flex flex-col gap-2">
                <h3 className="flex items-center font-semibold text-xl"><TimerIcon className="mr-2 w-4 h-4" />Abheben von der Masse</h3>

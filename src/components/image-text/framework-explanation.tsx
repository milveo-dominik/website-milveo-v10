    ...
    <div className="px-4 py-10 w-full" id="framework">
      <div className="mx-auto container">
        <div className="flex lg:flex-row flex-col lg:items-center gap-10">
          ...
          <img src="/logo.png" alt="Framework Explanation" className="brightness-0 dark:invert w-[90%] h-full object-cover" />
          <h3 className="font-bold text-[4rem] text-black md:text-[6rem] dark:text-white text-left leading-none">Framework</h3>
          </div>
